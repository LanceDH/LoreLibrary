...
-- Kalimdor
	...
	,{["id"] = 321	,["continent"] = "Kalimdor"	,["name"] = "Orgrimmar"			,["pointIds"] = {40, 41, 42, 43, 44, 45}}
...
,["points"] = {
	...
	,[37] = {["title"] = "Trader's Tier"		,["x"] = 42.4	,["y"] = 65.67	,["lore"] = "As the name implies, the Trader's Tier is where most of trade in Exodar takes place"}
	...
	,[42] = {["title"] = "Western Earthshrine"	,["x"] = 42.4	,["y"] = 65.67	,["lore"] = "The Western Earthshrine is a ritual circle erected by the Earthen Ring for use by the Horde.\nThe Earthshrine provides portals to Mount Hyjal, Vashj'ir, Deepholm, Uldum, Twilight Highlands and Tol Barad."}
