...
_addon.locals["S_AREA_NOLORE"] =				"<HTML><BODY><BR/><P align=\"CENTER\">Об этой области ещё ничего не известно.</P></BODY></HTML>" -- "<HTML><BODY><BR/><P align=\"CENTER\">Not much is known about this area.</P></BODY></HTML>"
_addon.locals["S_CONTINENT_DRAENOR"] =			"Дренор"	-- "Draenor"
_addon.locals["S_CONTINENT_EK"] =				"Восточные королевства"	-- "Eastern Kingdoms"
_addon.locals["S_CONTINENT_KALIMDOR"] =			"Калимдор"	-- "Kalimdor"
_addon.locals["S_CONTINENT_NORTHREND"] =		"Нордскол"	-- "Northrend"
_addon.locals["S_CONTINENT_OUTLAND"] =			"Запределье"	-- "Outland"
_addon.locals["S_CONTINENT_PANDARIA"] =			"Пандария"	-- "Pandaria"
_addon.locals["S_DAILY_SUGGESTIONS"] = 			"Ежедневные предположения" -- "Daily Suggestions"
_addon.locals["S_ERROR_COMBATLOCKDOWN"] =		"|cFFFF0000Вы не можете открыть Lore Library, пока учавствуете в бою.|r"	-- "|cFFFF0000You can't open Lore Library while in combat.|r"
_addon.locals["S_LIBRARY_ADDED"] =				"Добавлено в библиотеку."	-- "Added to your library."
_addon.locals["S_LORE_LIBRARY"] =				"Lore Library"	-- "Lore Library"
_addon.locals["S_LORE_COLLECTED"] =				"Знание изучено"	-- "Lore collected"
_addon.locals["S_LORE_NOT_COLLECTED"] =			"Знание не изучено"	-- "Lore not collected"
_addon.locals["S_LOSTPAGES_INFO"] =				"Вы можете использовать утерянную страницу,\nчтобы изучить знание"	-- "You can use a lost page\nto unlock this lore."
_addon.locals["S_LOSTPAGE_NONE"] = 				"У вас нет утерянных страниц"	-- "You have no lost pages available."
_addon.locals["S_LOSTPAGE_UNLOCK_INFO"] = 		"Вы можете использовать утерянную страницу,\nчтобы изучить знание"	-- "You can use a lost page\nto unlock this lore."
_addon.locals["S_LOSTPAGE_USE"] = 				"Использовать утерянную страницу, чтобы изучить знание"	-- "Use a lost page to unlock this lore."
_addon.locals["S_LOST_PAGES"] =					"Утерянные страницы"	-- "Lost pages"
_addon.locals["S_MARK_WORLDMAP"] = 				"Обозначить область на карте мира"	-- "Mark area on the world map"
_addon.locals["S_MATCH_AREA"] = 				"Исследованные области"	-- "Discovered areas"
_addon.locals["S_MATCH_ZONE"] = 				"Локации"	-- "Zones"
_addon.locals["S_MINIMAPBUTTON_INFO"] =			"Кликните, чтобы открыть вашу библиотеку"	-- "Click to open your library."
_addon.locals["S_NEW"] =						"Новое !"	-- "New !"
_addon.locals["S_OPTIONS_MAPOPTIONS"] =			"Метки на карте мира"	-- "World map pins"
_addon.locals["S_OPTIONS_MINIMAP"] =			"Кнопка у миникарты"	-- "Minimap button"
_addon.locals["S_OPTIONS_MOVEPOPUP"] =			"Переместить всплывающее сообщение"	-- "Move popup"
_addon.locals["S_OPTIONS_PINS_AREA"] =			"Область"	-- "Area"
_addon.locals["S_OPTIONS_PINS_LORE"] =			"Запись"	-- "Document"
_addon.locals["S_OPTIONS_PINS_TOOLTIPS"] =		"Подсказки"	-- "Tooltips"
_addon.locals["S_OPTIONS_PINS_UNLOCKED"] =		"Изучено"	-- "Unlocked"
_addon.locals["S_OPTIONS_POPUPOPTIONS"] =		"Всплывающее сообщение"	-- "Popups"
_addon.locals["S_OPTIONS_TOOLTIP"] =			"Индикатор в подсказке предмета"	-- "Tooltip indicator"
_addon.locals["S_OPTIONS_WORLDMAP_OVERLAY"] =	"Наложение на карту мира"	-- "World map overlay"
_addon.locals["S_PINS_OPTIONS_COLLECTED"] =		"Показывать изученные"	-- "Show collected"
_addon.locals["S_PINS_OPTIONS_SHOW"] =			"Показывать метки"	-- "Show pins"
_addon.locals["S_POI_BY_CONTINENT"] =			"Сортировать по континенту"	-- "Sort by continent"
_addon.locals["S_POI_COMPLETED"] =				"Завершено"	-- "Completed"
_addon.locals["S_POI_NOT_COMPLETED"] =			"Не завершено"	-- "Not completed"
_addon.locals["S_RIGHTCLICK_HIDE"] =			"Кликните правой кнопкой мыши, чтобы скрыть"	-- "Right click to hide."
_addon.locals["S_SOURCEINFO_CHEST"] =			"Может быть найдено в сундуке"	-- "Found in a type of chest."
_addon.locals["S_SOURCEINFO_CONTAINER"] =		"Может быть найдено в контейнере"	-- "Can be found in a container."
_addon.locals["S_SOURCEINFO_NPC"] =				"Может выпасть с"	-- "Can drop from an npc."
_addon.locals["S_SOURCEINFO_OBJECT"] =			"Объект в области"	-- "Object found in a zone."
_addon.locals["S_SOURCEINFO_QUEST"] =			"Получается в ходе выполнения задания"	-- "Obtained during a quest."
_addon.locals["S_SOURCEINFO_STEALTH"] =			"Может быть получено из карманов"	-- "Can pickpocket from an npc."
_addon.locals["S_SOURCEINFO_UNAVAILABLE"] =		"Более не доступно игрокам"	-- "Can no longer be obtained."
_addon.locals["S_SOURCEINFO_VENDOR"] =			"Продаётся торговцем"	-- "Sold by a vendor."
_addon.locals["S_SOURCETYPE_CHEST"] =			"Сундук"	-- "Chest"
_addon.locals["S_SOURCETYPE_CONTAINER"] =		"Контейнер"	-- "Container"
_addon.locals["S_SOURCETYPE_NPC"] =				"Добыча"	-- "Drop"
_addon.locals["S_SOURCETYPE_OBJECT"] =			"Объект"	-- "Object"
_addon.locals["S_SOURCETYPE_QUEST"] =			"Задание"	-- "Quest"
_addon.locals["S_SOURCETYPE_STEALTH"] =			"Обшаривание карманов"	-- "Pickpocket"
_addon.locals["S_SOURCETYPE_UNAVAILABLE"] =		"Недоступно"	-- "Unavailable"
_addon.locals["S_SOURCETYPE_VENDOR"] =			"Торговец"	-- "Vendor"
_addon.locals["S_SOURCE_TITLE"] =				"<HTML><BODY><BR/><P align=\"center\">Знание может быть получено из:</P><BR/></BODY></HTML>" -- "<HTML><BODY><BR/><P align=\"center\">This lore can be obtained from:</P><BR/></BODY></HTML>"
_addon.locals["S_SUGGESTION_COMPLETE"] =		"Предположение выполнено"	-- "Suggestion completed"
_addon.locals["S_SUGGESTION_EMPTY1"] =			"Вы собрали так много знаний!"	-- "You have collected so much lore!"
_addon.locals["S_SUGGESTION_EMPTY2"] =			"Не осталось ничего, что можно было бы предложить"	-- "There is nothing left to suggest."
_addon.locals["S_SUGGESTION_REMOVE"] =			"Удалить предположение, чтобы освободить место для нового"	-- "Remove this suggestion to make room for a new one."
_addon.locals["S_TAB_LORE"] =					"Записи"	-- "Documents"
_addon.locals["S_TAB_POI"] =					"Локации"	-- "Areas"
_addon.locals["S_TITLE_AREA"] =					"Библиотека локаций"	-- "Area Library"
_addon.locals["S_TITLE_DOCUMENT"] =				"Библиотека записей"	-- "Document Library"
_addon.locals["S_UNAVAILABLE_DETAIL"] =			"У этого знания больше нет доступных источников"	-- "This lore no longer has any\n available sources."
_addon.locals["S_UNLOCK_UNTIL_NEXT"] =			"Осталось до разблокировки:"	-- "Unlocks until next:"
_addon.locals["S_ZONE_COMPLETE"] =				"Локация завершена"	-- "Zone completed"
_addon.locals["S_CONTINENTS"] =					"Континенты"	-- "Continents"
_addon.locals["S_TIME_DAYS"] =					"дней"	 -- "days"
_addon.locals["S_TIME_DAY"] =					"день"	 -- "day"
_addon.locals["S_TIME_HOURS"] = 				"часов"	 -- "hours"
_addon.locals["S_TIME_MINS"] = 					"минут" 	-- "minutes"
_addon.locals["S_TIME_MIN"] = 					"минуту"	-- "minute"

_addon.locals["F_LORE_CONTENT"] =				"Знание содержит:\nСлов: %d\nСтраниц: %d \nИзображений: %d"	-- "Lore content:\nWords: %d \nPages: %d \nImages: %d"
_addon.locals["F_LOSTPAGE_INFO"] =				"Страницы разблокируются каждые %d фрагментов знаний, которые вы изучаете, и могут быть исользованы для изучения недоступных знаний"	-- "Pages are gained with every %d pieces of lore you unlock, and can be used to unlock unavailable lore."
_addon.locals["F_PAGE"] =						"Страница %d"	-- "Page %d"
_addon.locals["F_PROGRESS"] =					"%d/%d"	-- "%d/%d"
_addon.locals["F_SOURCE"] =						"%s\n%s"	-- "%s\n%s"
_addon.locals["F_SUGGESTION_REMOVECOOLDOWN"] =	"Может быть удалено через %s."	-- "Can be removed in %s."
_addon.locals["F_SUGGESTION_UNTILNEW"] =		"Новое предположение через %s."	-- "New suggestion in %s."
